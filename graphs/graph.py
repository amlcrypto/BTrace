...
class Graph():
    ...
    def draw_graph(self, wallet, user_id ,date_user_created, date_last_transactions):
        try:
            ...
            # # тут брать имеющийся граф из бд и красит его стрелки и ноды одним цветом, а новую транзу отдельно добавлять и другим цветом красить
